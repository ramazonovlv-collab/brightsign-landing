...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'gallery.volumetric.feature2': 'Индивидуальный дизайн',
    ...
    'gallery.lightbox.feature1': 'LED-подсветка с гарантией 1 год',
  ...
  uz: {
    ...
    'gallery.volumetric.feature2': 'Individual dizayn',
    ...
    'gallery.lightbox.feature1': '1 yil kafolatli LED yoritgich',
