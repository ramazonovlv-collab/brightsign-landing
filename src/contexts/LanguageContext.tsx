...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'gallery.volumetric.desc': 'Создаём уникальные объёмные буквы и конструкции с LED-подсветкой, которые привлекают внимание издалека и работают 24/7.',
    'gallery.volumetric.feature1': 'Объёмные буквы любой сложности',
    'gallery.volumetric.feature2': 'LED-подсветка с гарантией 3 года',
    ...
    'gallery.interior.desc': 'Комплексное оформление интерьеров: навигация, брендирование, декоративные элементы.',
    'gallery.interior.feature1': 'Навигационные системы',
    'gallery.interior.feature2': 'Брендирование пространств',
    'gallery.interior.feature3': 'Декоративные панели',
    ...
    'footer.service1': 'Широкоформатная печать',
    'footer.service2': 'Объемно-пространственные художественные композиции',
    'footer.service3': 'Световые короба',
    'footer.service4': 'Выставочные стенды',
    'footer.service5': 'Интерьерное оформление',
  ...
  uz: {
    ...
    'gallery.volumetric.desc': 'Uzoqdan e\'tiborni tortadigan va 24/7 ishlaydigan LED yoritgichli noyob hajmiy harflar va konstruktsiyalar yaratamiz.',
    'gallery.volumetric.feature1': 'Har qanday murakkablikdagi hajmiy harflar',
    'gallery.volumetric.feature2': '3 yil kafolatli LED yoritgich',
    ...
    'gallery.interior.desc': 'Interyerlarni kompleks bezash: navigatsiya, brendlash, dekorativ elementlar.',
    'gallery.interior.feature1': 'Navigatsiya tizimlari',
    'gallery.interior.feature2': 'Makonlarni brendlash',
    'gallery.interior.feature3': 'Dekorativ panellar',
    ...
    'footer.service1': 'Keng formatli bosma',
    'footer.service2': 'Hajmiy-fazoviy badiiy kompozitsiyalar',
    'footer.service3': 'Yorug\'lik qutilari',
    'footer.service4': 'Ko\'rgazma stendlari',
    'footer.service5': 'Interyer bezash',
